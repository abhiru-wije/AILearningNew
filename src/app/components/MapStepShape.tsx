      ...
      >
        ...
        <foreignObject x="170" y="140" width="400" height="400">
          <div className="flex flex-col items-center justify-center h-full">
            <motion.div 
              className={`mb-5 ${isLocked ? 'text-gray-400' :  colorSet.text} transition-transform duration-300 group-hover:scale-110`}
              animate={{
                y: [0, -5, 0],
                rotate: [0, 5, 0, -5, 0],
              }}
            ...
            >
              {isLocked ? <Lock size={60} /> : <span className="text-7xl">{icon}</span>}
            </motion.div>
            <motion.div 
              className={`text-6xl font-bold text-center ${isLocked ? 'text-gray-400' : colorSet.text} transition-transform duration-300 group-hover:scale-105`}
              animate={{
                scale: [1, 1.05, 1],
              }}
              transition={{
